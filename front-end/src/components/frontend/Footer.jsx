...
<footer className="footer">
  ...
  <section className="bg-info-subtle py-4 py-md-5 py-xl-8 border-top border-light">
      ...
      <div className="row gy-4 gy-lg-0 justify-content-xl-between">
        ...
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
          <div className="widget">
            ...
            <p className="mb-0">
              <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">JebbouriShop@gmail.com</a>
            </p>
          </div>
        </div>
        <div className="col-12 col-md-4 col-lg-3 col-xl-2">
  ...
  <div className="bg-info-subtle py-4 py-md-5 py-xl-8 border-top border-light-subtle">
    <div className="container overflow-hidden">
